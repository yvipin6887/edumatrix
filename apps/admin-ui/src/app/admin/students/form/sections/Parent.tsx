    ...
    <div className="space-y-6">
        <div className="flex flex-col md:flex-row gap-6">
            <div className="w-full">
                <h2 className="text-xl font-semibold text-gray-800 mb-4">Father Information</h2>
            ...
            <div className="w-full">
                <h2 className="text-xl font-semibold text-gray-800 mb-4">Mother Information</h2>
                <div className="grid grid-cols-1 gap-2">
                    <div>
                        <Input
                            type="text"
